...
public class CustomerFragment extends Fragment {
    ...
    private View view ;
    TextView tv_tv_displayNoCustomerRequ;
    ...
    public void onStart() {
        super.onStart();
        tv_tv_displayNoCustomerRequ = (TextView) view.findViewById(R.id.tv_displayCustomerRequ);
        ...
        List<requestCustomerToService> toServices = getRequestCustomerFromService ();
    ...
    private List<requestCustomerToService> getRequestCustomerFromService (){
        ...
        String path = null;
        try {
            providerInfo info = (providerInfo) cacheJson.readObject(getContext() , "info");
            path = "Service/"+info.getCatogery();
        } catch (IOException e) {
            e.printStackTrace();
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if(dataSnapshot.getValue() != null) {
                    // display list
                    tv_tv_displayNoCustomerRequ.setVisibility(View.GONE);
