...
public class requestCustomerToService {
    ...
    public requestCustomerToService(String id_customer, String name_customer, String email_customer, String phone_customer, String category, String date, String time, String description, Double lat, Double lng, String urlImage) {
